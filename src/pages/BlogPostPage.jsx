...
#SpaceExploration #Science #AstroPlay ${
      blog.category === "Climate Science"
        ? "#ClimateScience #Environment"
        : "#SpaceNews #Astronomy"
    }`;
...
${
  blog.category === "Space News"
    ? "#SpaceNews #Astronomy #Universe"
    : "#ClimateScience #Environment #Earth"
} #Science #Education #AstroPlay`;
                ...
                <div className="text-center">
                  ...
                  <div className="bg-black/20 backdrop-blur-sm rounded-lg p-4 max-w-md">
                    ...
                    <code className="text-xs text-blue-200 bg-black/30 px-3 py-1 rounded block">
                      /public
                      {blog.image || "/images/blogs/blog-" + blog.id + ".jpg"}
                    </code>
                  </div>
                </div>
              </div>
          ...
          <aside className="lg:col-span-1 mt-8 lg:mt-0">
            <div className="space-y-6 md:space-y-8 lg:sticky lg:top-8">
              ...
              {recentBlogs.length > 0 && (
                <div className="bg-slate-800 rounded-xl p-6 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/20 hover:scale-105 hover:bg-slate-700 group">
                      ...
                      >
                        <div className="flex gap-3">
                          ...
                          <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-purple-600 rounded-lg flex items-center justify-center flex-shrink-0 overflow-hidden">
                            ...
                            <span
                              className={`text-sm ${
                                recentBlog.image ? "hidden" : "block"
                              }`}
                              style={{
                                display: recentBlog.image ? "none" : "block",
                              }}
                            >
              ...
              {/* Contact Section */}
              <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-xl p-6 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/20 hover:scale-105 hover:from-blue-500 hover:to-purple-500 group">
                <div className="text-center">
              ...
              {/* Explore More */}
              <div className="bg-slate-800 rounded-xl p-6 transition-all duration-300 hover:shadow-2xl hover:shadow-green-500/20 hover:scale-105 hover:bg-slate-700 group">
